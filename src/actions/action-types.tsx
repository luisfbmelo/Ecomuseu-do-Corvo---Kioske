...
export const INFO_VIEWED_SET = 'INFO_VIEWED_SET';
export const INFO_VIEWED_RESET = 'INFO_VIEWED_RESET';
...
//  SETTINGS UPDATE
export const SETTINGS_UPDATE_RECEIVE = 'SETTINGS_UPDATE_RECEIVE';
